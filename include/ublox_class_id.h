#ifndef UBX_CLASS_ID_H
#define UBX_CLASS_ID_H

//The following are UBX Class IDs. Descriptions taken from ZED-F9P 
//Interface Description Document page 32, NEO-M8P Interface Description page 145
